...
h5_64d_profile()
{
    ...
    sed -i "s/switchMacAddress=.*/switchMacAddress=$MAC_ADDR/g" /usr/share/sonic/device/x86_64-nokia_ixr7220_h5_64d-r0/Nokia-IXR7220-H5-64D/profile.ini
    echo "Nokia-7220-H5-64D: Updated switch mac address ${MAC_ADDR}"
}
